...
export const EXTRA_HEADERS = new Option(
  ...
  'Additional HTTP headers to send with every Tolgee API request. Accepts a JSON object (e.g. \'{"X-Foo":"bar"}\') or comma-separated Name=Value pairs. Useful for traversing Cloudflare Access, WAFs, or other gateways.'
)
